...
$checkmail = mysqli_query($link,"SELECT * FROM users WHERE email='".make_safe($_GET['email'])."'");
$checknickname = mysqli_query($link,"SELECT * FROM users WHERE username='".make_safe($_GET['username'])."'");
